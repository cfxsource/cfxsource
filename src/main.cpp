...
unsigned int nStakeMinAge = 60 * 60 * 24;	// minimum age for coin age: 3h
...
int64 nChainStartTime = 1402818986;
...
const string strMessageMagic = "FinerCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in FinerCoin
    bool fStrictPayToScriptHash = true; // Always active in FinerCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FinerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "17/6/2014, the coins coming .";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1402818986;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5198699;
        if (false ) {
        ...
        assert(block.hashMerkleRoot == uint256("0x82cf265a5a803f14534aa160f4eb6b042c4bfe1385d721ed48551bde93027858"));//662dd4d3a997c34b02d5dfa52bf0f6ab4fd7849c0cc4912be16e136f23eced39"));
